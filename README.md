...
- scalable, security, reliable, globle reach
...
## AWS IAM
- Identity and access management service -> role and permission management by this service. this give who can access what. -> This is global servie i mean no region specific.

---

## AWS CLI 
- search aws cli download -> download to run aws command just like we do in ubuntu.
